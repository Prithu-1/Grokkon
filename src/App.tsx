        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-28 pb-20 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-9 max-w-lg">
              Grokkon tracks finances, manages inventory, monitors markets, and delivers AI-powered insights. Simplify expenses, reports, alerts, and daily operations in 22+ Indian languages, starting at ₹49/month.
            </p>
